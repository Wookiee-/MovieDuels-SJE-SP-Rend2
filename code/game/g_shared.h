...
constexpr auto MAX_CUSTOM_JEDI_SOUNDS = 24;
...
constexpr auto MAX_MISSION_OBJ = 250;
...
public:
		...
		ojk::SavedGameHelper& saved_game) const
	{
		...
		saved_game.write<int32_t>(sessionfaction);
		...
		ojk::SavedGameHelper& saved_game)
	{
		...
		saved_game.read<int32_t>(sessionfaction);
...
public:
		...
		ojk::SavedGameHelper& saved_game) const
	{
		...
		saved_game.write<int32_t>(enemyfaction);
		...
		saved_game.write<int32_t>(lasthurt_client);
		saved_game.write<int32_t>(lasthurt_mod);
		saved_game.write<int32_t>(lasthurt_location);
		...
		ojk::SavedGameHelper& saved_game)
	{
		...
		saved_game.read<int32_t>(enemyfaction);
		...
		saved_game.read<int32_t>(lasthurt_client);
		saved_game.read<int32_t>(lasthurt_mod);
		saved_game.read<int32_t>(lasthurt_location);
