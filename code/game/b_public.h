...
#define	NPCAI_BOSS_SERENITYJEDIENGINE  0x160000000	//Trying to fix lightningblock with this new one
...
#define	SCF_ONLY_SABER		0x100000000	//Has saber force powers but no other
#define	SCF_CLASS_GUARD		0x200000000	//Has saber force powers but no other
...
public:
	...
	float jumpMazZDist;
	int jumpSide; // Which Side The Last Jump Occurred On
	...
	/*
	int			weaponTime;		//Time until re fire is valid
	int			jumpTime;
	*/
