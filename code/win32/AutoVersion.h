...
#define VERSION_INTERNAL_BUILD		27  // Build day

#define VERSION_STRING				"Day-27,Month-04,Year-26,BuildNum-14" // build date
#define VERSION_STRING_DOTTED		"Day-27,Month-04,Year-26,BuildNum-14" // build date
