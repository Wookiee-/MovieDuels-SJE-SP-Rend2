...
#define VERSION_INTERNAL_BUILD		29  // Build day

#define VERSION_STRING				"Day-29,Month-04,Year-26,BuildNum-14" // build date
#define VERSION_STRING_DOTTED		"Day-29,Month-04,Year-26,BuildNum-14" // build date
